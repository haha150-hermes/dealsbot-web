...
function Privacy() { return <><Header /><main className="container narrow-page page"><p className="eyebrow">Integritet</p><h1>Integritetspolicy</h1><div className="prose"><h2>Vilka uppgifter samlas in?</h2><p>Dealsbot samlar inte in personuppgifter genom konto eller kommentarsfunktion på den här webbplatsen. Om du kontaktar redaktionen behandlas uppgifterna endast för att besvara ditt meddelande.</p><h2>Externa länkar</h2><p>När du följer en affiliatelänk lämnar du Dealsbot och omfattas av den externa webbplatsens villkor och integritetspolicy. Vi skickar inte in formulärdata till Amazon från Dealsbot.</p><h2>Cookies och loggar</h2><p>Driftleverantören kan behandla tekniska loggar för säkerhet och felsökning. Kontrollera aktuell cookie- och loggkonfiguration i deploymentmiljön innan webbplatsen lanseras.</p><h2>Frågor</h2><p>Kontakta redaktionen på <a className="text-link" href="mailto:kontakt@deals.symeri.se">kontakt@deals.symeri.se</a> om du har frågor om integritet.</p></div></main><Footer /></>; }
